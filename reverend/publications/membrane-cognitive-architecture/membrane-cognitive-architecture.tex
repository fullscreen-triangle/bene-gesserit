...
\hypersetup{
    ...
    citecolor=blue,
    urlcolor=blue,
    pdftitle={Membrane-Mediated Categorical Processing Architecture},
    pdfauthor={Kundai Farai Sachikonye}
}

\title{\textbf{Membrane-Mediated Categorical Processing Architecture: \\Trajectory Completion, Aperture-Based Filtering, and Partition Gradient Optimization on Amphiphilic Bilayer Substrates}}
